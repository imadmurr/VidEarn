...
object Constants {
    ...
    const val FIELD_INVITE_CODE: String = "inviteCode"
    const val FIELD_ADDED_DATE: String = "added_date"
    const val FIELD_AMOUNT: String = "amount"
    const val FIELD_PAID: String = "paid"
    const val FIELD_PTS_AMOUNT: String = "ptsAmount"
